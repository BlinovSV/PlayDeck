...
Decks_GOST24045_2016 = {
    ...
    'Н75-750': {'h': 75, 'b': 187.5, 'b_wf': 92, 'b_tf': 50, 'n_wfs' : 1, 'n_tfs': 0, 'n_ws': 1, 'b_wfs': 18, 'h_wfs': 7, 'b_wfs_s': 0, 'b_tfs': 0, 'h_tfs': 0, 'h_ws': 8, 'h_1': 46.5, 'h_s1': 8.5, 'h_2': 0, 'h_s2':0, 'r': 5, 'r_s': 4, 'n_cor': 4},
    'Н114-600': {'h': 114, 'b': 200.0, 'b_wf': 104, 'b_tf': 60, 'n_wfs': 1, 'n_tfs': 1, 'n_ws': 1, 'b_wfs': 18, 'h_wfs': 7, 'b_wfs_s': 0, 'b_tfs': 22, 'h_tfs': 7, 'h_ws': 8, 'h_1': 79.5, 'h_s1': 8.5, 'h_2': 0, 'h_s2': 0, 'r': 5, 'r_s': 4, 'n_cor': 3},
    'Н114-750': {'h': 114, 'b': 250.0, 'b_wf': 126, 'b_tf': 80, 'n_wfs': 2, 'n_tfs': 1, 'n_ws': 1, 'b_wfs': 18, 'h_wfs': 7, 'b_wfs_s': 42, 'b_tfs': 22, 'h_tfs': 7, 'h_ws': 8, 'h_1': 79.5, 'h_s1': 8.5, 'h_2': 0, 'h_s2': 0, 'r': 5, 'r_s': 4, 'n_cor': 3},
...
Decks_STO_57398459_18_2024 = {
    ...
    'Н114-600': {'h': 114, 'b': 200.0, 'b_wf': 104, 'b_tf': 60, 'n_wfs': 1, 'n_tfs': 1, 'n_ws': 1, 'b_wfs': 18, 'h_wfs': 7, 'b_wfs_s': 0, 'b_tfs': 18, 'h_tfs': 7, 'h_ws': 8, 'h_1': 79.5, 'h_s1': 8.5, 'h_2': 0, 'h_s2': 0, 'r': 5, 'r_s': 4, 'n_cor': 3},
    'Н114-750': {'h': 114, 'b': 250.0, 'b_wf': 126, 'b_tf': 80, 'n_wfs': 2, 'n_tfs': 1, 'n_ws': 1, 'b_wfs': 18, 'h_wfs': 7, 'b_wfs_s': 42, 'b_tfs': 18, 'h_tfs': 7, 'h_ws': 8, 'h_1': 79.5, 'h_s1': 8.5, 'h_2': 0, 'h_s2': 0, 'r': 5, 'r_s': 4, 'n_cor': 3},
...
with st.sidebar:
    ...
    t_coat = float(st.slider('Класс покрытия', min_value=60.0, max_value=430.0, value=275.0, step=5.0, format='%f')) * (7/100) / 1000000 # Толщина защитного покрытия
...
if (b_wf / t_nom > 300) or (b_tf / t_nom > 300):
    st.text('Не выполняется требование таблицы 7.1 СП 260.1325800.2023 по отношению ширины полки и толщины стенки')
elif (h / t_nom > 300) or (h / t_nom > 300 * m.sin(α)):
    st.text('Не выполняется требование таблицы 7.1 СП 260.1325800.2023 по соотношению высоты профиля и толщины стенки')
elif (0.25 > α / m.pi) or (α / m.pi > 0.5):
    st.text('Не выполняется требование таблицы 7.1 СП 260.1325800.2023 по углу наклона стенки')
elif max(r, r_s) > 0.04 * t_nom * E_s / R_y:
    st.text('Не выполняется требование п.7.2.8 СП 260.1325800.2023')
elif (b_wf/t_nom > 250 * h / b_wf) and (b_tf / t_nom > 250 * h / b_tf):
    st.text('Не выполняется требование п.7.3.1.2 СП 260.1325800.2023')
elif (h / t_nom > 220) or (min(r, r_s) / t_nom > 10):
    st.text ('Не выполняется требование к профлию для определения несущей способность по поперечной силе')
